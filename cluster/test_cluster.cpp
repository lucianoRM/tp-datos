...
int main(){
	...
	cout << cluster_doc1.get_docs() <<endl;
	Cluster cluster_doc2 = Cluster(&doc2,&nombre_doc2);
	cout << cluster_doc2.get_docs() <<endl;
	...
	cluster_doc1.recalcular(cluster_doc2.get_docs(),cluster_doc2.get_centroide(),cluster_doc2.get_cant_docs());
	cout << cluster_doc2.get_docs() <<endl;
